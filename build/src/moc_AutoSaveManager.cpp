...
struct qt_meta_stringdata_CLASSAutoSaveManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAutoSaveManagerENDCLASS = QtMocHelpers::stringData(
    "AutoSaveManager",
    "autoSave",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAutoSaveManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AutoSaveManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAutoSaveManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAutoSaveManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAutoSaveManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AutoSaveManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAutoSaveManagerENDCLASS.stringdata0))
